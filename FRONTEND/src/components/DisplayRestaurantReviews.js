...
function DisplayRestaurantReview({ restaurantId }) {
  ...
  const dummyReviews = [
    ...
    },
    {
      ...
      userName: "Tom Brown",
      rating: 3,
      comment: "Good pizza, but a bit too salty for my taste.",
    },
    {
      id: 4,
      ...
      rating: 5,
      comment: "Perfect steak! Best in town.",
    },
  ];
  ...
  useEffect(() => {
    ...
    setReviews(
      dummyReviews.filter(
        (review) => review.restaurantName === "The Gourmet Kitchen"
      )
    );
  }, [restaurantId]);
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="container bg-white shadow-lg rounded-lg px-4">
