...
function DisplayRestaurantLocation({ restaurantId }) {
  ...
  const dummyLocationData = {
    mapUrl:
      "https://www.google.com/maps/embed/v1/place?q=restaurant+location&key=YOUR_API_KEY", // Replace with real map URL
    shopNo: "123",
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 mb-6">
        ...
        <div className="mb-4">
          <strong className="text-gray-700">Shop No:</strong>{" "}
          {restaurantLocation.shopNo}
        </div>
        <div className="mb-4">
          <strong className="text-gray-700">Floor / Tower:</strong>{" "}
          {restaurantLocation.floorTower}
        </div>
        <div className="mb-4">
          <strong className="text-gray-700">Area / Sector / Locality:</strong>{" "}
        ...
        <div className="mb-4">
          <strong className="text-gray-700">Nearby Landmark:</strong>{" "}
          {restaurantLocation.nearbyLandmark}
        </div>
