...
function UserReviews() {
  ...
  const reviews = [
    ...
    {
      id: 2,
      hotelName: "Cozy Stay Inn",
      comment: "Very comfortable and affordable. Highly recommended.",
    },
    {
      id: 3,
      hotelName: "Luxury Palace",
      comment: "The ambiance and food were fantastic.",
    },
    {
      id: 4,
      hotelName: "Beachside Retreat",
      comment: "Beautiful location and great hospitality.",
    },
  ];
          ...
          {reviews.map((review) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-[18px] font-bold text-black mb-1">
                  {review.hotelName}
                </span>
