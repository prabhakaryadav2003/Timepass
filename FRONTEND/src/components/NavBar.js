    ...
    <nav className="navbar z-50 fixed top-0 bg-white shadow-md px-6 py-3 flex justify-between items-center w-full">
      <div className="flex items-center space-x-3">
        <img
          ...
          className="h-10 w-10"
        />
        <span className="text-2xl font-semibold text-gray-800">Table Heaven</span>
      </div>

      <div className="hidden md:flex items-center space-x-8">
        <a href="/restaurant" className="text-gray-700 hover:text-gray-900 text-lg transition duration-300 ease-in-out">
          Restaurant
        </a>
        <a href="/login" className="text-gray-700 hover:text-gray-900 text-lg transition duration-300 ease-in-out">
          Login
        </a>
        <a
          href="/signup"
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <a href="/login" className="text-gray-700 hover:text-gray-900 text-lg">
            Login
          </a>
          <a
            href="/signup"
