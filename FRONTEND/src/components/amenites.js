...
const Amenities = () => {
  return (
    <div className="amenities border-none flex flex-col justify-center items-center p-6 bg-gray-50 rounded-xl shadow-md">
      <div className="text-2xl font-semibold uppercase text-gray-800 mb-4">Amenities</div>
      <div className="flex flex-row justify-center items-center">
        ...
        <div className="m-4 flex flex-col items-center">
          ...
          <p className="text-sm mt-2 text-gray-600">Veg</p>
        </div>
        <div className="m-4 flex flex-col items-center">
        ...
        <div className="m-4 flex flex-col items-center">
          ...
          <p className="text-sm mt-2 text-gray-600">Air Conditioning</p>
        </div>
      </div>
    </div>
  );
